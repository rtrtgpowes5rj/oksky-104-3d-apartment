...
export class WalkControls{
  constructor(camera,element,{onLock=()=>{},onChange=()=>{}}={}){
    ...
    this.active=false;this.locked=false;this.keys=new Set();this.touch=null;this.speed=2.05;
  ...
  disable(){this.active=false;this.keys.clear();this.touch=null;if(document.pointerLockElement===this.element)document.exitPointerLock();}
  enter(view){
