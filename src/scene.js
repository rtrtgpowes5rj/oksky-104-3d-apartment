...
function materials(renderer){
  ...
  const joinery=loader.load('./assets/oak.jpg');joinery.colorSpace=THREE.SRGBColorSpace;joinery.wrapS=joinery.wrapT=THREE.RepeatWrapping;joinery.repeat.set(.6,.85);joinery.anisotropy=Math.min(8,renderer.capabilities.getMaxAnisotropy());
